...
exports.wdb = {
  ...
  D: bdb.key('D'),
  p: bdb.key('p', ['hhash']),
  P: bdb.key('P', ['uint32', 'hhash']),
  r: bdb.key('r', ['uint32', 'uint32', 'hhash']),
  w: bdb.key('w', ['uint32']),
  W: bdb.key('W', ['uint32']),
  l: bdb.key('l', ['ascii']),
  ...
  h: bdb.key('h', ['uint32']),
  b: bdb.key('b', ['uint32']),
  o: bdb.key('o', ['hhash256', 'uint32']),
  T: bdb.key('T', ['hhash256']),
  t: bdb.key('t', ['uint32'])
};
...
exports.txdb = {
  ...
  d: bdb.key('d', ['hhash256', 'uint32']),
  s: bdb.key('s', ['hhash256', 'uint32']),
  p: bdb.key('p', ['hhash256']),
  m: bdb.key('m', ['uint32', 'hhash256']),
  h: bdb.key('h', ['uint32', 'hhash256']),
  T: bdb.key('T', ['uint32', 'hhash256']),
  P: bdb.key('P', ['uint32', 'hhash256']),
  M: bdb.key('M', ['uint32', 'uint32', 'hhash256']),
  H: bdb.key('H', ['uint32', 'uint32', 'hhash256']),
  C: bdb.key('C', ['uint32', 'hhash256', 'uint32']),
  b: bdb.key('b', ['uint32'])
};
